...
import Naoscape.io.packets.*;
import Naoscape.Skills.*;
import Naoscape.players.Magic;
...
p.frames.setString(p, "NaoScape has been Updated!", 132, 45);
p.frames.setString(p, "Dragon Slayer Quest Added", 132, 1);
p.frames.setString(p, "Quest Cape Added", 132, 2);
p.frames.setString(p, "::savebackup and ::loadbackup added", 132, 3);
p.frames.setString(p, "Dragons now fight with fire and melee!", 132, 4);
p.frames.setString(p, "Ring quest added!", 132, 5);
...
p.frames.setString(p, "I have a quest for you.", 241, 4);
}
else
if(p.Dialogue == 4445) {
p.Dialogue = 4446;
...
p.frames.setNPCId(p, 6166, 241, 2);
p.frames.setString(p, "Sir Pelleas", 241, 3);
p.frames.setString(p, "Id like you to go and fetch me the Explorer's ring.", 241, 4);
}
else
if(p.Dialogue == 4446) {
p.Dialogue = 4447;
...
p.frames.setNPCId(p, 6166, 241, 2);
p.frames.setString(p, "Sir Pelleas", 241, 3);
p.frames.setString(p, "It was owned by a man named Larry.", 241, 4);
}
else
if(p.Dialogue == 4447) {
p.Dialogue = 4448;
...
p.frames.setNPCId(p, 6166, 241, 2);
p.frames.setString(p, "Sir Pelleas", 241, 3);
p.frames.setString(p, "But it's a DANGEROUS path to take!", 241, 4);
}
else
if(p.Dialogue == 4448) {
p.Dialogue = 4449;
...
p.frames.setNPCId(p, 6166, 241, 2);
p.frames.setString(p, "Sir Pelleas", 241, 3);
p.frames.setString(p, "Speak with Sir prysin to learn more", 241, 4);
}
else
if(p.Dialogue == 4449) {
p.Dialogue = 4450;
...
p.frames.setNPCId(p, 6166, 241, 2);
p.frames.setString(p, "Sir Pelleas", 241, 3);
p.frames.setString(p, "About the Explorer's ring.", 241, 4);
p.Quests = 1;
}
else
if(p.Dialogue == 20000) {
...
p.frames.setString(p, "Explorer's ring.", 241, 4);
}
else
if(p.Dialogue == 20001) {
p.Dialogue = 20002;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "Well i have heard of it.", 241, 4);
}
else
if(p.Dialogue == 20002) {
p.Dialogue = 20003;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "It's a ring once owned my a man named Larry.", 241, 4);
}
else
if(p.Dialogue == 20003) {
p.Dialogue = 20004;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "He was a great Explorer until he just vanished.", 241, 4);
}
else
if(p.Dialogue == 20004) {
p.Dialogue = 20005;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "No one knows where he is or where the ring is.", 241, 4);
}
else
if(p.Dialogue == 20005) {
p.Dialogue = 20006;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "His last known location was in Canifis.", 241, 4);
}
else
if(p.Dialogue == 20006) {
p.Dialogue = 20007;
...
p.frames.setNPCId(p, 883, 241, 2);
p.frames.setString(p, "Sir prysin", 241, 3);
p.frames.setString(p, "Well try talking to Hazeel in the North east of the Thieving area.", 241, 4);
p.Quests = 2;
}
else
if(p.Dialogue == 4982) {
...
p.frames.setString(p, "Well okay ill take you there right about", 241, 4);
...
p.frames.setNPCId(p, 892, 241, 2);
p.frames.setString(p, "Hazeel", 241, 3);
p.frames.setString(p, "NOW!", 241, 4);
p.setCoords(3491, 3486, 0);
p.requestForceChat("Wow thanks Hazeel!");
p.requestAnim(862, 1);
p.Quests = 3;
}
else
...
p.frames.setString(p, "oh it seems your on a hunt for the...", 241, 4);
}
else
if(p.Dialogue == 9941) {
p.Dialogue = 9942;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "You mean the SHUKALUKA!", 241, 4);
}
else
if(p.Dialogue == 9942) {
p.Dialogue = 9943;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "The great Explore ring!", 241, 4);
}
else
if(p.Dialogue == 9943) {
p.Dialogue = 9944;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "That's in the fist of guthix!", 241, 4);
}
else
if(p.Dialogue == 9944) {
p.Dialogue = 9945;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "Thats where Larry rests in peace!", 241, 4);
}
else
if(p.Dialogue == 9945) {
p.Dialogue = 9946;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "Well good luck on the hunt for the ring or the", 241, 4);
}
else
if(p.Dialogue == 9946) {
p.Dialogue = 9947;
...
p.frames.setNPCId(p, 5499, 241, 2);
p.frames.setString(p, "Eric", 241, 3);
p.frames.setString(p, "GREAT Ring", 241, 4);
p.Quests = 4;
}
else;
            p.viewings = 0;
...
if(p.Dialogue == 6) { YouShould(p, 7950, "Melee Tutor", "Fight Guards in the main hall..."); }
else
if(p.Dialogue == 7) { AcceptCape(p, 4288, "Ajjat", 9749, 9747); }
else
if(p.Dialogue == 8) { YouShould(p, 4288, "Ajjat", "Fight Guards in the main hall..."); }
else
if(p.Dialogue == 9) { AcceptCape(p, 4297, "Sloane", 9752, 9750); }
else
if(p.Dialogue == 10) { YouShould(p, 4297, "Sloane", "Fight Guards in the main hall..."); }
else
if(p.Dialogue == 11) { AcceptCape(p, 961, "Surgeon General Tafani", 9770, 9768); }
else
if(p.Dialogue == 12) { YouShould(p, 961, "Surgeon General Tafani", "Fight Guards in the main hall..."); }
else
